...
import { Message } from "../../interfaces/interfaces"; // Use proper interface name
...
export function MessageActions({ message }: MessageActionsProps) {
  ...
  // Only show actions for text responses
  if (typeof message.content !== 'string') return null;

  const handleCopy = () => {
    // Add type assertion since we already checked the type
